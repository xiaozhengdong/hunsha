...
import com.feilong.tools.scm.SVNPatchUtil;
...
public class SVNPatchUtilTest{
	...
	*//**
	 ...
	 *//*
	private final String[]			excludeFileNames	= { "log4j.xml", "messages/interface-config.properties" };

	private final SVNPatchUtil		svnPatchUtil		= new SVNPatchUtil();
	...
	*//**
	...
	public void printlnFileContent(){
		String fileName = "F:/svn-add update delete patch.txt";
