 ...
 * @author guili
 */
public interface ILcNetProductLogDao {
	/**
	 * 添加理财商品日志
	 * @param lcProduct
	 * @return
	 ...
	 * @return
	 */
	public int  selectProductNameNum() throws Exception ;
	
	/**
	 * 查询，理财产品名称数量
	 * @return
	 */
	public List<String>  selectOnepageProductName(int start, int size) throws Exception ;
	
	/**
	 * 查询，理财产品最近几个月的收益率
	 * @return
	 */
	public Double  recentNMonthIncome(String productName,int months) throws Exception ;
	/**
	 * 查询，理财产品最近几个月的收益
	 * @return
	 */
	public Double  recentNMonthPrice(String productName,int months) throws Exception ;
}
