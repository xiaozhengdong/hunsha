 ...
 *
 */
public class MilanSpider extends HunShaSpiderParent {

	private static Logger logger=Logger.getLogger(MilanSpider.class);
	...
	public List<HunshaCompanyBean> getCompanyListInfo(String listurl)
		...
		HunshaCompanyBean hunshaCompanyBean=HunShaSpiderCompanyEnum.getHunshaCompanyBean(HunShaSpiderCompanyEnum.MILAN);
