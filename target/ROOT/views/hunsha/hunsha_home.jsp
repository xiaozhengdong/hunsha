            ...
            <c:forEach  var="product" items="${bList}" varStatus="index">
				...
				<div class="act-item-wrap" data-bid="391365" id="j_brand_391365">
		             <div class="b_f_con_img_box">
		                 <a class="b_f_item_c" target="_blank" href="/hunsha/detail-${product.id}.htm">
		             ...
		             <div class="b_f_info">
		                  ...
		                  <a class="s_info_story is_story1" href="/hunsha/detail-${product.id}.htm" target="_blank"><span>${product.groupName }</span><i class="s_info_story_arrow"></i></a>
		                  </p>
		             </div>
		         </div>
		         </li>
