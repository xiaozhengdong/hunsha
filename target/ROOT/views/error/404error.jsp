...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div style="width: 1100px; margin: 50px auto 0px;padding-bottom: 50px;">
				...
				<p  class="helpp1"> 若有任何问题，请通过以下途径联系我们：（<a href="http://www.51maogou.com" target="_blank">www.51maogou.com</a>）,</p>
				<p  class="helpp">我们为您提供实时、可靠、全面的理财产品查询和信息比较服务。</p>
				<p  class="helpp">友情链接：maogou_51@163.com</p>
				<p class="helpp">其他事宜：maogou_51@163.com</p>
